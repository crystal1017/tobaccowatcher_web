...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tobaccowatcher_trend', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Trend.start_date'
        db.alter_column(u'tobaccowatcher_trend', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Trend.end_date'
        db.alter_column(u'tobaccowatcher_trend', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Trend.start_date'
        db.alter_column(u'tobaccowatcher_trend', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
