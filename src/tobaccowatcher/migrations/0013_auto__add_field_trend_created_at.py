...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trend.created_at'
        db.add_column(u'tobaccowatcher_trend', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 6, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trend.created_at'
        db.delete_column(u'tobaccowatcher_trend', 'created_at')
