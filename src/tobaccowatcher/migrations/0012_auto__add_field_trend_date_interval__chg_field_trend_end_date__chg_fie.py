...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trend.date_interval'
        db.add_column(u'tobaccowatcher_trend', 'date_interval',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


        # Changing field 'Trend.end_date'
        db.alter_column(u'tobaccowatcher_trend', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Trend.start_date'
        db.alter_column(u'tobaccowatcher_trend', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Trend.date_interval'
        db.delete_column(u'tobaccowatcher_trend', 'date_interval')


        # Changing field 'Trend.end_date'
        db.alter_column(u'tobaccowatcher_trend', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 6, 30, 0, 0)))

        # Changing field 'Trend.start_date'
        db.alter_column(u'tobaccowatcher_trend', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 6, 30, 0, 0)))
