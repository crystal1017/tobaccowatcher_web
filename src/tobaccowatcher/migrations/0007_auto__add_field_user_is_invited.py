...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_invited'
        db.add_column(u'tobaccowatcher_user', 'is_invited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field shared on 'UserAlert'
        m2m_table_name = db.shorten_name(u'tobaccowatcher_useralert_shared')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('useralert', models.ForeignKey(orm[u'tobaccowatcher.useralert'], null=False)),
            ('user', models.ForeignKey(orm[u'tobaccowatcher.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['useralert_id', 'user_id'])


    def backwards(self, orm):
        # Deleting field 'User.is_invited'
        db.delete_column(u'tobaccowatcher_user', 'is_invited')

        # Removing M2M table for field shared on 'UserAlert'
        db.delete_table(db.shorten_name(u'tobaccowatcher_useralert_shared'))
