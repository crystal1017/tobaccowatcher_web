...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tobaccowatcher_feedback', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Feedback.date_created'
        db.alter_column(u'tobaccowatcher_feedback', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now=True))
