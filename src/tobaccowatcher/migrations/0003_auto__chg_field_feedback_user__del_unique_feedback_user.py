...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Feedback', fields ['user']
        db.delete_unique(u'tobaccowatcher_feedback', ['user_id'])


        # Changing field 'Feedback.user'
        db.alter_column(u'tobaccowatcher_feedback', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tobaccowatcher.User']))

    def backwards(self, orm):

        # Changing field 'Feedback.user'
        db.alter_column(u'tobaccowatcher_feedback', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tobaccowatcher.User'], unique=True))
        # Adding unique constraint on 'Feedback', fields ['user']
        db.create_unique(u'tobaccowatcher_feedback', ['user_id'])
